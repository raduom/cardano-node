...
cardano-cli query stake-address-info \
            ...
            --address stake_test17r6ju53vp4xdt9cyezpuxv8hsyf5chcqmq2jmvlv5wrqz4qj3pjl8 \
...
STAKE_ADDRESS=$(jq -r '.[0].address' queries/stake-address-info.json)
BALANCE=$(jq -r '.[0].rewardAccountBalance' queries/stake-address-info.json)
...
cardano-cli transaction build \
            ...
            --withdrawal "${STAKE_ADDRESS}+${BALANCE}" \
